...
(function ($) {
    ...
    var methods = {
         ...
         * @param {string} [switcherID] - language switcher DOM ID.
         * @param {string} [switcherLanguageText] - language full text name which will be shown on language switcher.
         */
        '_translate': function (languageCode, switcherID, switcherLanguageText) {

            $(switcherID).text(switcherLanguageText);
         ...
         */
        'translate': function (languageCode, switcherID, switcherLanguageText) {
            var $this = this;

            methods._translate.call($this, languageCode, switcherID, switcherLanguageText);

            // must also select the language when translating via the public method
            methods._selectLanguage.call($this, languageCode, switcherID, switcherLanguageText);
